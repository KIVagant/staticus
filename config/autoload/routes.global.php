...
return [
    'dependencies' => [
        ...
        'factories' => [
            ...
            Staticus\Resources\File\PrepareResourceMiddleware::class => Staticus\Resources\File\PrepareResourceMiddlewareFactory::class,
            Staticus\Resources\File\SaveResourceMiddleware::class => Staticus\Resources\File\SaveResourceMiddlewareFactory::class,
            Staticus\Resources\Mpeg\PrepareResourceMiddleware::class => Staticus\Resources\Mpeg\PrepareResourceMiddlewareFactory::class,
            Staticus\Resources\Mpeg\SaveResourceMiddleware::class => Staticus\Resources\Mpeg\SaveResourceMiddlewareFactory::class,
            Staticus\Resources\Gif\PrepareResourceMiddleware::class => Staticus\Resources\Gif\PrepareResourceMiddlewareFactory::class,
            Staticus\Resources\Gif\SaveResourceMiddleware::class => Staticus\Resources\Gif\SaveResourceMiddlewareFactory::class,
            Staticus\Resources\Jpg\PrepareResourceMiddleware::class => Staticus\Resources\Jpg\PrepareResourceMiddlewareFactory::class,
            Staticus\Resources\Jpg\SaveResourceMiddleware::class => Staticus\Resources\Jpg\SaveResourceMiddlewareFactory::class,
            Staticus\Resources\Png\PrepareResourceMiddleware::class => Staticus\Resources\Png\PrepareResourceMiddlewareFactory::class,
            Staticus\Resources\Png\SaveResourceMiddleware::class => Staticus\Resources\Png\SaveResourceMiddlewareFactory::class,
        ],
        ...
        'types' => [
            ...
            Staticus\Resources\File\ResourceDO::class => Staticus\Resources\File\ResourceDO::class,
            Staticus\Resources\ResourceImageDOInterface::class => Staticus\Resources\Jpg\ResourceDO::class,
            Staticus\Resources\Mpeg\ResourceDO::class => Staticus\Resources\Mpeg\ResourceDO::class,
            Staticus\Resources\Gif\ResourceDO::class => Staticus\Resources\Gif\ResourceDO::class,
            Staticus\Resources\Jpg\ResourceDO::class => Staticus\Resources\Jpg\ResourceDO::class,
            Staticus\Resources\Png\ResourceDO::class => Staticus\Resources\Png\ResourceDO::class,
